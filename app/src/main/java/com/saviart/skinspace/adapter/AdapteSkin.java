...
public class AdapteSkin extends RecyclerView.Adapter<AdapteSkin.ItemViewHolder>{
    ...
    public AdapteSkin(Context context, int layout, List<Construtor_ListItems> itemsList,OnClickIteml OnClickIteml) {
        this.data = itemsList;
        this.layout = layout;
        context = context;
        onClickIteml=OnClickIteml;
